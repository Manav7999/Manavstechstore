...
async function main() {
  ...
  // Copy ManavsTech Store App APK and icon
  copyFileIfExists('ManavsTech Store.apk', 'manavstech-store.apk');
  copyFileIfExists('ManavsTech app Store iconlogo.png', 'manavstech-store-icon.png');
